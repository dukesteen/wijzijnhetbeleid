const SITE_CONTENT = {
  ...
  stories: {
    main: {
      ...
      theme: "main",
      title:
        "HOE LOSSEN WE INGEWIKKELDE MAATSCHAPPELIJKE VRAAGSTUKKEN OP?",
    ...
    markemodel: {
      ...
      sections: [
        ...
        },
        {
          ...
          paragraphs: [
            "Het Markemodel is een samenwerking tussen alle betrokken partijen binnen de landbouw. 'Elke partij, van boer tot overheid, heeft evenveel rechten en plichten\u2019, aldus Johan. Samen werken al die partijen toe naar gemeenschappelijke doelen om de landbouw te verduurzamen.",
